...
public class Game
{
    ...
    {   
        ...
        //Maybe add a menu here before starting the new game??
        //Choose start new game = createNewGame()
        //Help = showHelp()?
    ...
    {
        //setPlayerName() a method that makes seperate popup asking player's name and set player's name
        //showIntro() a method that shows seperate panel with introduction
        totalPredators = 0;
        totalKiwis = 0;
        predatorsTrapped = 0;
        kiwiCount = 0;
    ...
    ****************************************************************************************************************/
    ...
    /**
     * Set player's name manually
     */
    public void enterPlayerName(){
        initialName = JOptionPane.showInputDialog(null, "Enter Your Name Please");
    };
