...
public class KiwiCountUI extends javax.swing.JFrame implements GameEventListener{
    ...
    /**
     * This methods enable movement of the player with keyboard arrow input
     * 
     */
    ...
    private void initComponents() {
        ...
        btnMoveNorth.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnMoveNorthKeyPressed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        btnMoveSouth.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnMoveSouthKeyPressed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        btnMoveEast.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnMoveEastKeyPressed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        btnMoveWest.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnMoveWestKeyPressed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void btnMoveNorthKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnMoveNorthKeyPressed
        keyPressed(evt);
    }//GEN-LAST:event_btnMoveNorthKeyPressed

    private void btnMoveSouthKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnMoveSouthKeyPressed
        keyPressed(evt);
    }//GEN-LAST:event_btnMoveSouthKeyPressed

    private void btnMoveWestKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnMoveWestKeyPressed
        keyPressed(evt);
    }//GEN-LAST:event_btnMoveWestKeyPressed

    private void btnMoveEastKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnMoveEastKeyPressed
        keyPressed(evt);
    }//GEN-LAST:event_btnMoveEastKeyPressed
